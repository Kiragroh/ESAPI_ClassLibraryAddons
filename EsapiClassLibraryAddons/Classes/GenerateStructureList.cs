				      ...
				      //(structure.Id.Contains("R50_", StringComparison.InvariantCultureIgnoreCase) == false))
				       {
                        ...
                        structure.DicomType.Equals("GTV") & !structure.Id.StartsWith("z", StringComparison.InvariantCultureIgnoreCase))
                    {
                        ...
                        structure.DicomType.Equals("CTV") & !structure.Id.StartsWith("z", StringComparison.InvariantCultureIgnoreCase))
                    {
                        ...
                        structure.DicomType.Equals("PTV")&!structure.Id.StartsWith("z", StringComparison.InvariantCultureIgnoreCase))
					      {
